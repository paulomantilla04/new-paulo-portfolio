      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 top-full mt-2 min-w-37.5 flex flex-col gap-1 p-2 rounded-2xl bg-black/80 backdrop-blur-md border-[6px] border-black/20 origin-top-right z-100"
          >
            {options.map((option) => {
